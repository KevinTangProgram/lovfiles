    ...
    return (<>
        <Navbar/>
            <div style={{"display": "flex", "flexDirection": "column"}}>
                ...
                <p1 style={{"textAlign": "center", "marginLeft": "auto", "marginRight": "auto", "fontSize": "20px", "lineHeight": "150%", "marginBottom": "2vh"}}>LOV Homes is committed to the art and design of building new homes. Homes that embrace your everyday life and reflect our clients’ unique timeless character.</p1>
            ...
            <div className="testimonialWidth">
                ...
                <div className="markKevin">
                    ...
                    <p1 style={{"marginRight": "60px", "fontSize": "18px", "lineHeight": "150%", "marginTop": "auto", "marginBottom": "auto"}}>“I couldn't believe how easy and affordable it was to get our dream home with LOV Homes. The innovative approach they use made the whole process a breeze, and we were able to save a significant amount of money. The best part is how seamlessly our new home blends into the community. LOV Homes truly delivered on their promise!”<br></br>- Mark Cuban</p1>
                </div>
                <div className="lori">
                    <p1 style={{"marginLeft": "70px", "fontSize": "18px", "lineHeight": "150%", "marginTop": "auto", "marginBottom": "auto"}}>“LOV Homes has made our dream of homeownership a reality. Their commitment to saving us money while delivering a beautiful, quality home is truly remarkable. We can't thank them enough for their innovative approach and dedication to making the process stress-free.”<br></br>- Lori Greiner</p1>
                ...
                <div className="markKevin">
                    ...
                    <p1 style={{"marginRight": "60px", "fontSize": "18px", "lineHeight": "150%", "marginTop": "auto", "marginBottom": "auto"}}>“LOV Homes has transformed the way we think about homeownership. Their commitment to affordability and innovation is evident in every aspect of their homes. We're thrilled with the seamless integration into our community and the savings we enjoyed. Thank you, LOV Homes!”<br></br>- Kevin O’Leary</p1>
                </div>
            </div>
        <Footer/>
    </>)
